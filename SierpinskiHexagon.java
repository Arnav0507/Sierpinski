...
public class SierpinskiHexagon extends JPanel implements ActionListener, KeyListener{
    JFrame frame;
    ...
    public void run(){
        points = new ArrayList<Point>();
        points.add(new Point(300, 100, Color.WHITE));
        points.add(new Point(500, 100, Color.WHITE));
        points.add(new Point(200, 273, Color.WHITE));
        points.add(new Point(600, 273, Color.WHITE));
        points.add(new Point(300, 446, Color.WHITE));
        points.add(new Point(500, 446, Color.WHITE));
        ...
        }while(!hexagon.contains(xRand, yRand));
    ...
    public static void main(String[] args){
        SierpinskiHexagon app = new SierpinskiHexagon();
    }
